          ...
          <div className="grid gap-12 md:grid-cols-[1.1fr_0.9fr] md:items-center">
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <Link
                  href="/markets"
                  className="border-2 border-[#00d9ff] bg-[#0a0a0f] px-4 py-2 text-sm font-black tracking-wider text-[#00d9ff] uppercase transition-all hover:bg-[#00d9ff] hover:text-[#0a0a0f] hover:shadow-[0_0_20px_rgba(0,217,255,0.4)]"
                >
                  MARKETS
                </Link>
                <Link
